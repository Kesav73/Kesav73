...
B.Tech in Data Science & AI at **IIT Bhilai** (CGPA: 9.22)

Currently **AI Intern @ Valuai.io** — building production GenAI systems
...
**AI/ML:** LangChain, LangGraph, FAISS, HuggingFace, TensorFlow, scikit-learn

**Tools:** AWS (Bedrock, SageMaker), Docker, Git, MongoDB
